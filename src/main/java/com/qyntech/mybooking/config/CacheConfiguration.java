package com.qyntech.mybooking.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MyBooking");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MyBooking");
        ...
        config.getMapConfigs().put("com.qyntech.mybooking.domain.*", initializeDomainMapConfig(jHipsterProperties));
